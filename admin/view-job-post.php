...
<head>
  ...
  <title>Softufon JobPortal</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index.php" class="logo logo-bg">
      ...
      <span class="logo-lg"><b>Softufon</b> JobPortal</span>
    </a>
  ...
  <footer class="main-footer" style="margin-left: 0px;">
    <div class="text-center">
      <strong>Copyright &copy; 2023 <a href="learningfromscratch.online">Softufon JobPortal</a>.</strong> All rights
    reserved.
    </div>
  </footer>
